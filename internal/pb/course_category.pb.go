...
// Define a blank message to be used on services that does not need parameters
type Blank struct {
...
// Define the category object, like a struct entity
...
// Define the Request DTO for creating a new category (only with the payload needed)
...
// Define the request DTO for getting one category by ID
...
// Define the get all categories proto DTO
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x69, 0x65, 0x73, 0x32, 0x83, 0x02, 0x0a, 0x0f, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79,
	...
	0x69, 0x73, 0x74, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65,
	0x67, 0x6f, 0x72, 0x79, 0x12, 0x1a, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74,
	...
	0x79, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x28, 0x01, 0x42, 0x0d, 0x5a, 0x0b, 0x69, 0x6e, 0x74,
...
var file_proto_course_category_proto_depIdxs = []int32{
	...
	3, // 3: pb.CategoryService.GetCategory:input_type -> pb.GetCategoryByIdRequest
